...
class credentialManager:NSObject,AWSCognitoIdentityInteractiveAuthenticationDelegate{
    ...
    func startPasswordAuthentication()->AWSCognitoIdentityPasswordAuthentication{
        ...
        dispatch_async(dispatch_get_main_queue()) {
            ...
            var rootView = (UIApplication.sharedApplication().delegate!).window!!.rootViewController!
            rootView.presentViewController(loginViewC as! UIViewController, animated: true, completion: {
